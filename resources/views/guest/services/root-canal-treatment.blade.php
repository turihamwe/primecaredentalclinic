	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
				...
				<h2>Safe root canal procedure</h2>
				<p>Safety is our peak priority here at Primecare dental clinic. This applies to all our procedures, including root canal treatment procedures.</p>
				...
				<p>Root canal procedures can be high-risk procedures if strict infection control and disposal procedures are not followed strictly enough. Here, we have listed some of the safety protocol we practice at Primecare dental clinic to ensure cleanliness and safety during your root canal procedures.</p>
				<h2>Single-use shaping files and irrigation needles</h2>
				...
				<p>We use equipment such as the NSK Apex Locator, NSK Rotary endodontic Handpiece. The use of these materials, known to be effective, help to enhance the success rate of treatment for our patients.</p>
				<h2>Crowning</h2>
				<p>Following root canal (endodontic) treatment, we recommend a crown to be placed on the tooth to provide a proper coronal seal against leakage of oral fluids into the mouth and future fracturing.</p>
			</div>
		</div>
