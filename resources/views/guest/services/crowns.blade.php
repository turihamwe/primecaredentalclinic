...
<div class="about-us">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-12">
				<img src="{{ asset('images/services/precious-metal-crown.jpg') }}" alt="">
			</div>
		</div>
	</div>
</div>
...
<div class="about-us">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 col-sm-12">
				<img src="{{ asset('images/services/lithium-disilicate-crown.jpg') }}" alt="">
			</div>
		</div>
	</div>
</div>
<div class="about-us">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 col-sm-12">
				<img src="{{ asset('images/services/zirconia-crown.jpg') }}" alt="">
			</div>
		</div>
	</div>
</div>
<div class="about-us">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 col-sm-12">
				<img src="{{ asset('images/services/stainless-steel-crown.jpg') }}" alt="">
			</div>
		</div><br>
