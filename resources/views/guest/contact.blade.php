			...
			<div style="padding:20px" class="col-sm-6">
				...
				<form action="{{ route('contact') }}" method="POST">
					...
					<div class="row">
						...
						<div class="col-sm-8"><input name="name" type="text" placeholder="Eg. John Doe" class="form-control input-sm"></div>
					</div>
					...
					<div style="margin-top:10px;" class="row">
						...
						<div class="col-sm-8"><input name="phone" type="text" placeholder="Eg. 256784392100" class="form-control input-sm"></div>
					</div>
					<div style="margin-top:10px;" class="row">
...
<div style="margin-bottom:5%;" class="row no-margin">
	<div style="overflow:hidden;max-width:100%;width:100%;height:450px;"><div id="my-map-canvas" style="height:100%; width:100%;max-width:100%;"><iframe style="height:100%;width:100%;border:0;" frameborder="0" src="https://www.google.com/maps/embed/v1/place?q=Pulse+Uganda,+Stretcher+Road,+Kampala,+Uganda&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"></iframe></div><a class="googlecoder" href="https://www.bootstrapskins.com/themes" id="grab-map-info">premium bootstrap themes</a><style>#my-map-canvas .text-marker{}.map-generator{max-width: 100%; max-height: 100%; background: none;}</style></div>
</div>
