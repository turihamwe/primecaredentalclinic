	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-key">
					{{-- <i class="fas fa-hospital-alt"></i> --}}
					<img src="{{ asset('images/services/icons/dental-fillings.jpg') }}" alt="">
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-key">
					{{-- <i class="fas fa-hospital-alt"></i> --}}
					<img src="{{ asset('images/services/icons/oral-disease-prevention.jpg') }}" alt="">
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-key">
					...
					<img src="{{ asset('images/services/icons/general-dentistry.jpg') }}" alt="">
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-key">
					...
					<img src="{{ asset('images/services/icons/airflow-treatment.jpg') }}" alt="">
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-key">
					...
					<img src="{{ asset('images/services/icons/oral-surgery.jpg') }}" alt="">
					<h5>Oral surgery</h5>
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-key">
					...
					<img src="{{ asset('images/services/icons/dental-hygiene.jpg') }}" alt="">
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-key">
					...
					<img src="{{ asset('images/services/icons/glass-ceramic-restorations.jpg') }}" alt="">
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-key">
					...
					<img src="{{ asset('images/services/icons/inlays-onlays.jpg') }}" alt="">
					<h5>Inlays & onlays</h5>
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-key">
					...
					<img src="{{ asset('images/services/icons/bridges.jpg') }}" alt="">
					<h5>Bridges</h5>
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-key">
					{{-- <i class="fas fa-user-md"></i> --}}
					<img src="{{ asset('images/services/icons/clear-aligners-invisalign.jpg') }}" alt="">
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-key">
					{{-- <i class="fa fa-ambulance"></i> --}}
					<img src="{{ asset('images/services/icons/teeth-whitening.jpg') }}" alt="">
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-key">
					{{-- <i class="fas fa-briefcase-medical"></i> --}}
					<img src="{{ asset('images/services/icons/space-maintainers.jpg') }}" alt="">
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-key">
					{{-- <i class="fas fa-capsules"></i> --}}
					<img src="{{ asset('images/services/icons/root-canal-treatment.jpg') }}" alt="">
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-key">
					{{-- <i class="fas fa-prescription-bottle-alt"></i> --}}
					<img src="{{ asset('images/services/icons/gum-reshaping.jpg') }}" alt="">
					<h5>Gum reshaping</h5>
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-key">
					{{-- <i class="fa fa-h-square"></i> --}}
					<img src="{{ asset('images/services/icons/mouthwash.jpg') }}" alt="">
					<h5>Mouthwash</h5>
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-key">
					{{-- <i class="fa fa-heartbeat"></i> --}}
					<img src="{{ asset('images/services/icons/digital-dental-xrays.jpg') }}" alt="">
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-key">
					{{-- <i class="fa fa-plus-square"></i> --}}
					<img src="{{ asset('images/services/icons/root-planing.jpg') }}" alt="">
					<h5>Root planing</h5>
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-key">
					{{-- <i class="fa fa-stethoscope"></i> --}}
					<img src="{{ asset('images/services/icons/wisdom-molar-extraction.jpg') }}" alt="">
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-key">
					{{-- <i class="fas fa-hospital-alt"></i> --}}
					<img src="{{ asset('images/services/icons/sinus-lift.jpg') }}" alt="">
					<h5>Sinus lift</h5>
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-key">
					{{-- <i class="fas fa-user-md"></i> --}}
					<img src="{{ asset('images/services/icons/topical-fluoride-application.jpg') }}" alt="">
