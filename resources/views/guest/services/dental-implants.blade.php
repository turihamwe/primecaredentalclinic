	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
				...
				<p>A dental implant is a surgical component that is placed into the jawbone to replace a missing tooth or teeth. It is typically made of titanium or other biocompatible materials that fuse with the surrounding bone in a process called osseointegration.</p><br><img src="{{ asset('images/visa.jpg') }}" width="300px" height="auto" alt="">
